...
export function todayKey(): string {
  // UTC date — matches the website leaderboard page (biokea.ai/mission/games/leaderboard)
  // which also uses UTC. All games use UTC so seeds are consistent regardless of timezone.
